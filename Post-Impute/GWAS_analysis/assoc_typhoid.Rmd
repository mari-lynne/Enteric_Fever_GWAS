...
knitr::opts_knit$set(root.dir = '~/GWAS_22/new_gwas/just_typhoid/assoc')
...
--pheno ~/GWAS_22/new_gwas/just_typhoid/meta/typhoid_pheno.txt \
--pheno-name Diagnosed \
--covar ~/GWAS_22/new_gwas/just_typhoid/meta/typhoid_covar.txt \
