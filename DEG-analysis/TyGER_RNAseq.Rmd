...
knitr::opts_knit$set(root.dir = '/home/mari/RNA') #Permanently sets wd for Rmd
```
...
keep.exprs <- filterByExpr(data$counts)
...
plot_dir <- paste(getwd(),"plots/tyger/", sep = "/")
...
group = as.factor(data$samples$visit)
#Set up group to plot/colours
lcpm <- cpm(data, log = TRUE)
col.group <- group
levels(col.group) <- scalebrewer.pal(nlevels(col.group), "Accent")
levels(col.group) <- brewer.pal(nlevels(col.group), "Accent")
col.group <- as.character(col.group)

#Plot MDS
png(paste(plot_dir, "visit.png", sep = ""))
